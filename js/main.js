(() => {
  ...
  let enterNewScene = false; // 새로운 scene 이 시작한 순간 true
  ...
  /**
   * opacity 계산
   * @param {*} values opacity 값
   * @param {*} currentYOffset 현재 씬에서 얼마나 스크롤 됐는지
   */
  function calcsValues(values, currentYOffset) {
    let rv;
